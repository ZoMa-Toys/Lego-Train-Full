...
function switchIfYouCan(cardID){
    let neighbourSwitch = trackConfig.cardPairs[cardID][2];
    ...
    /* else if (neighbourSwitch[0]="i"){

        let brakeCardIndex=-1;
        if (sw.sw) = trackConfig[neighbourSwitch[1]].card_index["i"];
        console.log(brakeCardIndex)
        modifySectionInUse(brakeCardIndex,true);
    } */
    if(pulse!=-1){
