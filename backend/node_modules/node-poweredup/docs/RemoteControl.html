...
<head>
	...
	<title>node-poweredup Class: RemoteControl</title>
...
<div class="row">
	...
	<h1 class="page-title">Class: RemoteControl</h1>
<section>
...
<hr>
<dt>
    <h4 class="name" id="RemoteControl"><span class="type-signature"></span>new RemoteControl()</h4>
...
<dd>
    ...
    <div class="description">
        <p>The RemoteControl is emitted if the discovered device is a Remote Control.</p>
    </div>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="hubs_remotecontrol.js.html">hubs/remotecontrol.js</a>,
				 <a href="hubs_remotecontrol.js.html#sunlight-1-line-27">line 27</a>
			</li>
		</ul>
	</dd>
