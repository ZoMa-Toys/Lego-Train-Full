...
<head>
	...
	<title>node-poweredup Class: MoveHub</title>
...
<div class="row">
	...
	<h1 class="page-title">Class: MoveHub</h1>
<section>
...
<hr>
<dt>
    <h4 class="name" id="MoveHub"><span class="type-signature"></span>new MoveHub()</h4>
...
<dd>
    ...
    <div class="description">
        <p>The MoveHub is emitted if the discovered device is a Move Hub.</p>
    </div>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="hubs_movehub.js.html">hubs/movehub.js</a>,
				 <a href="hubs_movehub.js.html#sunlight-1-line-31">line 31</a>
			</li>
		</ul>
	</dd>
