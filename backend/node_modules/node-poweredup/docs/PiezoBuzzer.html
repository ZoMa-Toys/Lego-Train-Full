...
<head>
	...
	<title>node-poweredup Class: PiezoBuzzer</title>
...
<div class="row">
	...
	<h1 class="page-title">Class: PiezoBuzzer</h1>
<section>
...
<hr>
<dt>
    <h4 class="name" id="PiezoBuzzer"><span class="type-signature"></span>new PiezoBuzzer()</h4>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="devices_piezobuzzer.js.html">devices/piezobuzzer.js</a>,
				 <a href="devices_piezobuzzer.js.html#sunlight-1-line-25">line 25</a>
			</li>
		</ul>
	</dd>
...
<hr>
<dt>
    <h4 class="name" id="playTone"><span class="type-signature"></span>playTone(frequency, time)</h4>
...
<dd>
    ...
    <div class="description">
        <p>Play a tone on the Hub's in-built buzzer</p>
    </div>
...
<span class="param-type">number</span>
            ...
            <td class="description last"><p>How long the tone should play for (in milliseconds).</p></td>
        </tr>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="devices_piezobuzzer.js.html">devices/piezobuzzer.js</a>,
				 <a href="devices_piezobuzzer.js.html#sunlight-1-line-33">line 33</a>
			</li>
		</ul>
	</dd>
...
<div class="param-desc">
    <p>Resolved upon successful completion of command (ie. once the tone has finished playing).</p>
</div>
