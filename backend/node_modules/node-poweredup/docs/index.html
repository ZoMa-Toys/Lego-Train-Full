...
<h3>Announcements</h3>
<ul>
<li>v6.8.0 adds support for LEGO Super Mario.</li>
</ul>
<h3>Introduction</h3>
...
<li>
<p>The SPIKE Prime Hub does not use Bluetooth Low Energy, so is not supported via this library. It is recommended you use MicroPython to develop for this Hub using the officially provided tools and software.</p>
</li>
<li>
